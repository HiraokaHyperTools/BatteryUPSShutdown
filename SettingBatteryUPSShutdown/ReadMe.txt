========================================================================
ATL (ACTIVE TEMPLATE LIBRARY) : SettingBatteryUPSShutdown プロジェクトの概要
========================================================================

この SettingBatteryUPSShutdown プロジェクトは、ユーザーがダイナミック リンク ライ
...
SettingBatteryUPSShutdown.vcproj
...
SettingBatteryUPSShutdown.idl
    このファイルには、プロジェクトで定義されるタイプ ライブラリの IDL 定義、
    インターフェイス、およびコクラスが含まれます。
    このファイルは MIDL コンパイラによって処理され、次のものが生成されます。
        C++ のインターフェイス定義と GUID 宣言 (SettingBatteryUPSShutdown.h)
        GUID 定義                              (SettingBatteryUPSShutdown_i.c)
        タイプ ライブラリ                      (SettingBatteryUPSShutdown.tlb)
        マーシャリング コード                  (SettingBatteryUPSShutdown_p.c および dlldata.c)

SettingBatteryUPSShutdown.h
    このファイルには、C++ のインターフェイス定義および 
    SettingBatteryUPSShutdown.idl. で定義される項目の GUID 宣言が含まれます。
    コンパイル中に MIDL によって再生成されます。

SettingBatteryUPSShutdown.cpp
    このファイルには、オブジェクト マップおよび DLL のエクスポートの実装が
    含まれます。

SettingBatteryUPSShutdown.rc
    これは、プログラムで使用する Microsoft Windows の全リソースの一覧です。

SettingBatteryUPSShutdown.def
...
StdAfx.h, StdAfx.cpp
    ...
    SettingBatteryUPSShutdown.pch とプリコンパイル済み型ファイル StdAfx.obj 
    をビルドするために使用します。
...
SettingBatteryUPSShutdownps.vcproj
	...
	SettingBatteryUPSShutdown_i.c と SettingBatteryUPSShutdown_p.c が生成され
        ます。

SettingBatteryUPSShutdownps.def
